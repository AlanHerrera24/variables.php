...
<body> 
    ...
    <?php // Definición de variables 
     $nombre = "George Lucas"; 
     $edad = 60; $ciudad = "Ciudad de México"; 
     $precioProducto = 300; 
     $iva= 1.16;
     // Definición de una constante 
     Const EMPRESA = "LucasFilms"; 
     ...
     <?php // Operaciones matemáticas con variables 
     ...
     echo "<p>Precio con IVA: <strong>$$precioiva</strong></p>"; 
     // Concatenación de cadenas
     $mensaje = "Bienvenido " . $nombre . " a " . EMPRESA . "."; echo "<p>$mensaje</p>"; ?> 
</body>
</hmtl>